class GoodsDetailModel {
  ...
  GoodsDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null
        ? new GoodsDetailInfoModel.fromJson(json['data'])
        : null;
  }
...
class GoodsDetailInfoModel {
  ...
  GoodsDetailInfoModel(
      {this.goodInfo, this.goodComments, this.advertesPicture});

  GoodsDetailInfoModel.fromJson(Map<String, dynamic> json) {
